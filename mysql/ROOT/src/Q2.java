...
public class Q2 extends HttpServlet {
	...
	private static final String QUERY = "SELECT `tweet_id`, `score`, `censored_text` from q2 WHERE user_id=? AND timestamp=?";
	...
	protected void doGet(HttpServletRequest request,
		...
		if (request.getParameter("userid") == null
				|| request.getParameter("tweet_time") == null) {
		...
		try {
			...
			Date date = (Date) sdf.parse(request.getParameter("tweet_time"));
